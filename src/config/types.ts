 ...
 */
export type FunctionImportHandler = (
  ctx: HookContext,
...
export abstract class EntityHandler {
  ...
  async onRead(ctx: HookContext): Promise<unknown[]> {
    throw new Error('Not implemented');
  }

  async onReadSingle(ctx: HookContext): Promise<unknown | null> {
    throw new Error('Not implemented');
  }

  async onCreate(ctx: HookContext, data: unknown): Promise<unknown> {
    throw new Error('Not implemented');
  }
  ...
  async onDelete(ctx: HookContext): Promise<void> {
    throw new Error('Not implemented');
  }
