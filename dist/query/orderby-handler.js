...
exports.parseOrderByPath = parseOrderByPath;
exports.buildOrderByWithAssociations = buildOrderByWithAssociations;
/**
 * Build Sequelize order clause from $orderby options
 */
function buildOrderBy(orderby, entityName, schema) {
    const order = [];
 ...
 */
function buildOrderItem(item, entityName, schema) {
 ...
 */
function parseOrderByPath(path, entityName, schema) {
 ...
 */
function buildOrderByWithAssociations(orderby, entityName, schema, models) {
    const order = [];
    for (const item of orderby) {
...
//# sourceMappingURL=orderby-handler.js.map