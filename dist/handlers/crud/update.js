 ...
 */
async function handleUpdate(req, res, handler, entityName, keys, schema, query, basePath, models, sequelize) {
    const odataReq = req;
    const baseCtx = {
        req: req,
        res: res,
 ...
 */
async function handleMerge(req, res, handler, entityName, keys, schema, query, basePath, models, sequelize) {
    const odataReq = req;
    const baseCtx = {
        req: req,
        res: res,
